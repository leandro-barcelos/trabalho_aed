/*
        TAD Lista Fila dinamica, encadeamento circular simples de pacientes.
...
/*
    Operação: imprimir_fila
    Entrada: endereço da fila
    Pré-condições: lista ser valida e não estar vazia
    Processo: imprime a fila da base ao topo
    Saída: a lista impressa
